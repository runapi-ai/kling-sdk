...
import ai.runapi.kling.types.TextToVideoResponse;
    ...
    class KlingLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/kling/text_to_video", this::handleRequest);
        server.start();
      }
      ...
      CompletedTextToVideoResponse response =
        ...
        assertEquals("/api/v1/kling/text_to_video", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/kling/text_to_video/task_local_123", captured.path);
