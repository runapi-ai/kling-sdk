...
Use `kling-v3-omni-reference` with text-to-video for image-only reference inputs. For a source video, use edit-video with either `kling-v3-omni-reference` or `kling-v3-omni-edit`; the reference model keeps sound disabled.
